...
PERSONAS: Mapping[str, Persona] = {
    "practical_marketer": Persona(
        "practical_marketer", "Маркетолог-практик",
    ...
    "evidence_analyst": Persona(
        "evidence_analyst", "Доказательный аналитик",
    ...
    "founder_operator": Persona(
        "founder_operator", "Фаундер-оператор",
    ...
    "clear_teacher": Persona(
        "clear_teacher", "Понятный наставник",
...
PLATFORM_PROFILES: Mapping[str, PlatformProfile] = {
    "zen": PlatformProfile(
        "zen", "Дзен", "широкая аудитория с разным уровнем подготовки",
    ...
    "vc": PlatformProfile(
        "vc", "VC.ru", "предприниматели, специалисты и руководители",
