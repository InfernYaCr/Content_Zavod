...
async def test_directions_command_reports_default_when_unset() -> None:
    ...
    await handle_directions_command(settings_store, gateway, chat_id=1)
...
async def test_set_directions_splits_trims_and_persists() -> None:
    ...
    await handle_set_directions_command(settings_store, gateway, chat_id=1, args="  a  , b ,c")
...
async def test_set_directions_drops_empty_items_from_double_and_trailing_commas() -> None:
    ...
    await handle_set_directions_command(settings_store, gateway, chat_id=1, args="a,,b,")
...
async def test_set_directions_keeps_duplicates() -> None:
    ...
    await handle_set_directions_command(settings_store, gateway, chat_id=1, args="a, a, b")
...
async def test_set_directions_rejects_empty_args_without_side_effects() -> None:
    ...
    await handle_set_directions_command(settings_store, gateway, chat_id=1, args="")
